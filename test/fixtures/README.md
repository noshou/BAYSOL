...
| [`functions/`](#shared-test-BayesolUtils-functions)               | Shared`.jl` BayesolUtils                                                        |
...
## Shared test BayesolUtils (`functions/`)

Shared test-geometry/data BayesolUtils (`.jl`, `include`d directly).
