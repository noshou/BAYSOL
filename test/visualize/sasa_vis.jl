...
#   julia --project=test/visualize -e 'include("test/visualize/sasa_vis.jl"); vis_sasa_mesh_convergence()'
#   julia --project=test/visualize -e 'include("test/visualize/sasa_vis.jl"); vis_sasa_molecule(cluster_scene().mol)'
#
