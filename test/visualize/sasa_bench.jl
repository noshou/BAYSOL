...
#   julia --project=test/visualize -e 'include("test/visualize/sasa_bench.jl"); bench_report()'
#
# Write the raw sweep to CSV for external analysis:
#   julia --project=test/visualize -e 'include("test/visualize/sasa_bench.jl"); accuracy_sweep("sweep.csv")'
#
